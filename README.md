...
```bash
brew install --cask coderunner zoom google-chrome alfred notion microsoft-teams airbuddy visual-studio-code android-studio dbeaver-community docker figma iina postman sf-symbols sourcetree subtitles surge telegram transmission virtualbox virtualbox-extension-pack imazing
```
